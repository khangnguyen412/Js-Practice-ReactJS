...
export const LectureRoute = [
    ...
    {
        path: '/choose-lecture',
        element: <Suspense fallback={<p>Đang tải...</p>}> <ChooseLecture></ChooseLecture> </Suspense>
    },
    {
        path: '/chapter2-lecture1',
        element: <Suspense fallback={<p>Đang tải...</p>}> <Chap2Lecture01></Chap2Lecture01> </Suspense>
    },
    {
        path: '/chapter2-lecture2',
        element: <Suspense fallback={<p>Đang tải...</p>}> <Chap2Lecture02></Chap2Lecture02> </Suspense>
    },
    {
        path: '/chapter2-lecture3-1',
        element: <Suspense fallback={<p>Đang tải...</p>}> <Chap2Lecture03FC></Chap2Lecture03FC> </Suspense>
    },
    {
        path: '/chapter2-lecture3-2',
        element: <Suspense fallback={<p>Đang tải...</p>}> <Chap2Lecture03CC></Chap2Lecture03CC> </Suspense>
    },
    {
        path: '/chapter2-lecture4',
        element: <Suspense fallback={<p>Đang tải...</p>}> <Chap2Lecture04></Chap2Lecture04> </Suspense>
    },
    {
        path: '/chapter2-lecture5',
        element: <Suspense fallback={<p>Đang tải...</p>}> <Chap2Lecture05></Chap2Lecture05> </Suspense>
    },
    {
        path: '/chapter3-lecture1',
        element: <Suspense fallback={<p>Đang tải...</p>}> <Chap3Lecture01></Chap3Lecture01> </Suspense>
    },
    {
        path: '/chapter3-lecture2',
        element: <Suspense fallback={<p>Đang tải...</p>}> <Chap3Lecture02></Chap3Lecture02> </Suspense>
    },
    {
        path: '/chapter3-lecture3',
        element: <Suspense fallback={<p>Đang tải...</p>}> <Chap3Lecture03></Chap3Lecture03> </Suspense>
    },
    {
        path: '/chapter3-lecture4',
        element: <Suspense fallback={<p>Đang tải...</p>}> <Chap3Lecture04></Chap3Lecture04> </Suspense>
    },
    {
        path: '/chapter3-lecture5',
        element: <Suspense fallback={<p>Đang tải...</p>}> <Chap3Lecture05></Chap3Lecture05> </Suspense>
    },
    {
